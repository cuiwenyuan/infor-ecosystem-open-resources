---
title: "Infor CPQ - Infor 生态第三方资源导航站"
...
| 资源 | 说明 |
|------|------|
| [Sama Consulting - CPQ 销售效率指南](https://samaconsultinginc.com/blogs/maximizing-sales-efficiency-with-infor-cpq-a-step-by-step-guide/) | CPQ 配置、定价、集成、实施全流程深度解析 |
| [InforLogic - CPQ for Manufacturers](https://inforlogic.com/blog/infor-cpq-for-manufacturers/) | 制造商 CPQ 应用场景与最佳实践（2026 持续更新）|
| [RenaissanceTech - CPQ 官网](https://renaissancetech.com/) | CPQ 实施案例与解决方案介绍 |
| [Infor 官方 - CPQ 产品介绍（中文）](https://www.infor.cn/resources/cpq-reinvents-the-buying-experience) | CPQ 如何重塑购买体验（中文资源）|
| [Infor 官方 - CPQ Brochure（PDF）](https://dam.infor.com/api/public/content/e56b26661dd54ae3bed647d34eb4861b?v=154e1780) | 官方 CPQ 产品手册 |
...
- **复杂产品制造**：按订单配置（CTO），如工业设备、汽车零部件
- **按订单设计（ETO）**：大型定制设备，CPQ 自动生成 BOM 和工艺路线
- **家具/门窗行业**：客户自助配置 + 自动报价
- **电子制造**：复杂 BOM 配置 + 价格计算
...
| 集成对象 | 说明 |
|---------|------|
| **Infor LN / M3 / CSI** | 报价 → 销售订单 → 生产订单，BOM/工艺路线自动创建 |
| **Infor CRM** | 销售线索 → CPQ 报价 → 成交 |
| **CAD 系统** | 配置结果自动生成 CAD 模型与图纸 |
| **Infor ION** | BOD 消息驱动跨系统协同 |

---

## 相关产品

- [Infor LN](ln.md) — CPQ 配置结果驱动 LN 生产订单
- [Infor M3](m3.md) — 同上（流程制造）
- [Infor CRM](crm.md) — 销售流程前端
- [Infor OS](infor-os.md) — CPQ 运行平台
