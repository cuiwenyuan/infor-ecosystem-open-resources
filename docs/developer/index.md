...
| 资源名称 | 简介 | 适用产品 | 链接 |
|---------|--------|---------|------|
| **XtendM3** | M3 云扩展开发框架，支持实时修改业务逻辑 | Infor M3 | [GitHub](https://github.com/infor-cloud/xtendm3) |
| **XtendM3 示例仓库** | 官方扩展示例集合 | Infor M3 | [GitHub](https://github.com/infor-cloud/xtendm3-extension-examples) |
| **XtendM3 Java SDK** | XtendM3 Java SDK | Infor M3 | [GitHub](https://github.com/infor-cloud/xtendm3-sdk-java) |
| **XtendM3 Maven 插件** | XtendM3 Maven 构建插件 | Infor M3 | [GitHub](https://github.com/infor-cloud/xtendm3-maven-plugin) |
